...
class UserRouter extends BaseRouter {
  ...
  static router () {
    ...
    router.post('/', UserRouter.createRoute(UserRouter.createUser, UserRouter.createUserSchema))
    return router
  }
   ...
   * @returns {Promise}
   */
  static createUser (validatedReq, res) {
...
UserRouter.createUserSchema = Joi.object({
  body: Joi.object({
    githubId: Joi.number().required(),
