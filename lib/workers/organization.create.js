 ...
 * @param {Number}    rawJob.creator                - Object with creator user details
 * @param {Number}    rawJob.creator.githubId       - Object with creator user details
 * @param {Number}    rawJob.creator.githubId       - Creator's githubId
 * @param {Number}    rawJob.creator.githubUsername - Creator's github login
 * @param {Number}    rawJob.creator.email          - Creator's email address
 * @param {Number}    rawJob.creator.created        - Date the user was created
 * @return {Promise}
 */
