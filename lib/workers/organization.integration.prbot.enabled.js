...
const logger = require('util/logger').child({ module: 'worker/organization.integration.prbot.enabled' })
...
module.exports.task = function PrBotEnabled (job) {
  const log = logger.child({ job: job, method: 'PrBotEnabled' })
  log.info('PrBotEnabled called')
