...
module.exports = new ponos.Server({
  ...
  tasks: {
    ...
    'organization.cleanup': require('./organization.cleanup')
  },
  events: {
    'organization.authorized': require('./organization.authorized'),
    'organization.disable.requested': require('./organzation.disabled.requested'),
    ...
    'time.one-day.passed': require('./time.one-day.passed')
  }
})
