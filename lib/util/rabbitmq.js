  ...
  constructor () {
    super({
      ...
      events: [{
        ...
        name: 'organization.disable.requested',
        jobSchema: RabbitMQ.publishOrganizationDisableRequestedSchema
      }, {
...
RabbitMQ.publishOrganizationDisableRequestedSchema = Joi.object({
  tid: Joi.string().guid(),
