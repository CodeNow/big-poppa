...
const UnauthorizedError = require('lib/errors/unauthorized_error')
const RegistryDoesNotSupportLoginError =  require('lib/errors/registry-does-not-support-login-error')
