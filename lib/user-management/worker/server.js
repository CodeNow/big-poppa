...
server.setTask('user.create', require('./user.create'))
server.setTask('user.delete', require('./user.delete'))
server.setTask('organization.user.add', require('./organization.user.add'))
server.setTask('organization.user.remove', require('./organization.user.remove'))
