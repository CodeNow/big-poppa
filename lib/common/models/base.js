...
module.exports = {
  ...
  extend: function (modelName, prototypePropertiesAndMethods, staticMethods) {
    ...
    return bookshelf.model(
      modelName,
      Object.assign(prototypePropertiesAndMethods, this.prototypeMethods, prototypePropertiesAndMethods),
      Object.assign(staticMethods, this.staticMethods, staticMethods)
    )
  },
  ...
  staticMethods: {
    ...
    fetchByGithubId: Promise.method(function (githubId) {
      ...
      return new Model({ github_id: githubId }).fetch({ require: true })
        .catch(Model.castDatabaseError.bind(Model))
    }),
