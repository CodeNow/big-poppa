 ...
 * @type {object}
 */
var creamlSerializers = {
  err: errorSerializer,
  env: envSerializer
}

defaults(creamlSerializers, bunyan.stdSerializers)

/**
 * Creates a new Cream logger with the given name and custom serializers.
...
function create (name, serializers) {
  ...
  defaults(serializers, creamlSerializers)
